# AI Career Journey — Nilima Satapathy
...
## Live status (update when you ship)

| Track | Current | Status |
|-------|---------|--------|
| **Project 1** — API automation | **Complete** (M1–M8 · 77 tests · CI) | ✅ Done |
| **Project 2** — Playwright POM | **M1–M4 done** (9 tests + fail traces) | 🟡 |
...
| 2 | `playwright-pom-saucedemo` | UI automation · Playwright · POM (in progress) | [Open](https://github.com/nilima-satapathy/playwright-pom-saucedemo) |
| 3 | `rag-doc-qa` | RAG · embeddings · deploy | *coming soon* |
| 4 | `llm-eval-dashboard` | LLM evaluation · golden set · quality gates | *coming soon* |

---

## Roadmap (10 weeks, build-first)

```text
Week 1     Foundations + first LLM call
Week 2     ★ Project 1 (API) — COMPLETE (M1–M8)
Week 3     ★ Project 2 (Playwright) — M1–M4 done
...
Full local plan (on my machine): `Desktop/Code/AI-Career-Plan/`

---

## How I log progress on GitHub

Every time a **project milestone** is done:

1. Code + tests green in that project repo  
2. Update that repo’s `MILESTONES.md`  
3. Commit: `feat(mX): …` and tag: `milestone-X`  
4. Update **this** repo’s [`PROGRESS.md`](./PROGRESS.md)  
5. (Optional) Create a GitHub Release on the project repo named `Milestone X`

See [`docs/GITHUB_WORKFLOW.md`](./docs/GITHUB_WORKFLOW.md) for copy-paste commands.

---

## About me

- 4+ years product QA — **Microsoft Dynamics 365** & **Google Nest** (HCL)  
